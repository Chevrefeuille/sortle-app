...
<template>
  ...
  >
    <div class="hidden text-right text-gray-200 md:block">Low</div>
    <div v-for="(val, i) in props.values" :key="i">
      <div
    ...
    <div class="hidden text-right text-gray-200 md:block">High</div>
  </div>
</template>
